...
This syllabus outlines the **Data Analysis Toolkit for Food and Nutrition Sciences** for MSc students. It includes 26 Jupyter notebooks across six modules, rendered as HTML tutorials in `_site/notebooks/`. Hippo-themed datasets (🦛) teach practical data analysis skills.
...
| `4.3_correlation_analysis.ipynb` | `correlation_analysis.html` | Analyse correlations. |
...
4. **Data Analysis**: Analyse data (Weeks 7–8).
5. **Advanced Topics**: Explore advanced methods (Weeks 9–10).
6. **Qualitative Research**: Analyse text (Week 11).
